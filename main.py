...
class DeviceCard(QFrame):
    def __init__(self, device_id, count, main_wall, parent=None):
        ...
        self.lbl_title = QLabel(f" 📱 [{count}] ID: {device_id}", self)
        ...
        # Dikunci ke aspek rasio layar lebar 720p (Skala 16:9 murni)
        self.video_frame.setMinimumSize(QSize(360, 640))
...
class GlassDeviceWall(QWidget):
    def __init__(self, device_ids):
        super().__init__()
        # Maksimal 20 Device terdeteksi
        self.device_ids = device_ids[:20]
        self.processes = []
        self.cards = []
        
        # Konfigurasi Paginasi (4 per halaman)
        self.current_page = 0
    ...
    def init_ui(self):
        self.setWindowTitle("Android Device Wall Control Panel - 20 Max Devices")
        ...
        title_label.setStyleSheet("font-size: 20px; font-weight: 800; color: #FFFFFF; letter-spacing: 0.5px;")
        header_layout.addWidget(title_label)
        header_layout.addStretch()
        
        # MENU DROPDOWN PERANGKAT CONNECTED DI ATAS
    ...
    def update_page_ui(self):
        """Memperbarui grid halaman untuk menampilkan 4 device dalam susunan 2x2"""
        # Hentikan proses lama terlebih dahulu
        ...
        # Hitung indeks item halaman ini
        ...
        # Tata ke susunan grid 2x2 murni
        cols = 2
        for index, dev_id in enumerate(page_devices):
            ...
            card = DeviceCard(dev_id, global_index, self, self.container_widget)
