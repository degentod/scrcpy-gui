...
class RainXLoadingScreen(QWidget):
    ...
    def init_ui(self):
        ...
        # DI SINI FIX-NYA: Ditambahkan parameter QFont.AbsoluteSpacing agar tidak error
...
class GlassDeviceWall(QWidget):
    ...
    def mass_sideload_apk(self):
        ...
        for dev_id in self.device_ids:
            try:
                res = subprocess.run(["adb", "-s", dev_id, "install", "-r", file_path], capture_output=True, text=True)
...
if __name__ == '__main__':
    ...
    # Fungsi callback untuk memanggil window utama asli scrcpy-gui
    def launch_main_app():
        global main_win
    ...
    # Eksekusi Animasi Loading Terlebih Dahulu
